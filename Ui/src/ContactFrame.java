...
public class ContactFrame extends JFrame {
    public ContactFrame(String title) {
        ...
        ImageIcon iconFemale = new ImageIcon("C:\\java\\java-level-one\\Ui\\src\\woman.png");
        ...
        buttonSave.setBounds(140, 300, 100, 30);
        buttonClear.setBounds(260, 300, 100, 30);
    ...
    public static void main(String[] args) {
        ContactFrame contactFrame = new ContactFrame("Contact");
