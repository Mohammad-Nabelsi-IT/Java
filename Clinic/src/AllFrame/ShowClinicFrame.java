...
public class ShowClinicFrame extends JFrame {
    ...
    public ShowClinicFrame(Clinic clinic , Users user) {
        ...
        PatientsFrame panel1 = new PatientsFrame(clinic);
        ShowAllPatientPanel panel2 = new ShowAllPatientPanel(clinic);
        AppointmentPanel panel3 = new AppointmentPanel(clinic,user);
    ...
    class ShowAllPatientPanel extends JPanel {
                ...
                public void mouseClicked(MouseEvent e) {
                   ...
                   Patient patient;
                    try {
                        ...
                        Patient patient1= patientDao.get(Integer.parseInt(pid));
                        PDetailFram patientDetailsForm = new PDetailFram(patient1);
        ...
        private void fillTable() {
            ...
            try {
                Connection cn = DBConfig.createConnection();
                PatientDao patientDao = new PatientDao(cn);
                ArrayList<Patient> list = patientDao.getByClinic(clinic.getId());
            ...
            table.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    try {
                        ...
                        PDetailFram patientDetailsForm = new PDetailFram(patient);
                        patientDetailsForm.setVisible(true);
